          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><Link to="/" className="text-gray-400 hover:text-white transition-colors">Available Experiments</Link></li>
            ...
            <div>
              ...
              <div className="flex space-x-2">
                <Button variant="outline" size="icon" className="bg-transparent border-gray-700 hover:bg-gray-800 text-gray-400 hover:text-white">
